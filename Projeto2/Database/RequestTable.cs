...
namespace BookEditor
{
    public class RequestTable : DatabaseTable
    {
        ...
        public const string KEY_STATE_DESC = "state_desc";
        ...
        {
            return String.Format("create table {0} ({1} INTEGER PRIMARY KEY AUTOINCREMENT, {2} INTEGER NOT NULL, {3} INTEGER NOT NULL, {4} TEXT NOT NULL, {5} INTEGER NOT NULL DEFAULT 0, {6} INTEGER NOT NULL DEFAULT 0, {7} TEXT, {8} TEXT);", getTableName(), KEY_ID, KEY_ORDER_ID, KEY_BOOK_ID, KEY_TITLE, KEY_QUANTITY, KEY_STATE, KEY_DATE, KEY_STATE_DESC);
        }
    }
}
