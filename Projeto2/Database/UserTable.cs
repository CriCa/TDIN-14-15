...
namespace BookEditor
{
    public class UserTable : DatabaseTable
    {
        ...
        {
            return String.Format("create table {0} ({1} INTEGER PRIMARY KEY AUTOINCREMENT, {2} TEXT, {3} TEXT UNIQUE, {4} TEXT NOT NULL);", getTableName(), KEY_ID, KEY_NAME, KEY_EMAIL, KEY_PASSWORD);
        }
    }
}
